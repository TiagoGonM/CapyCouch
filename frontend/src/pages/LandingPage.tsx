        ...
        <div className="flex-grow flex items-center">
          <div className="pl-8 md:pl-16 lg:pl-24 border-l-4 border-[#c4853a]">
            ...
            <p className="mt-4 text-xl md:text-2xl text-[#cddbe5]">
              Encuentra, descubre y decide entre cientos de <span className="text-[#c4853a]">peliculas y series entre amigos</span>
            </p>
          </div>
        </div>
        ...
        <section className="w-full bg-[#2b2f31] p-8 md:p-16 border-t-4 border-[#c4853a]">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-semibold text-[##cddbe5] mb-4">
              Elige peliculas con <span className="text-[#c4853a]">Avanzada IA</span>
            </h2>
            <p className="text-[##cddbe5] mb-4 text-lg">
              Ofrecemos una <span className="text-[#c4853a]">Gran Solucion</span> Para resolver el dilema de las juntadas con amigos ¿que pelicula ver?.
            </p>
            <p className="text-[##cddbe5] text-lg">
              Utilizamos las opiniones de los usuarios en grupos, para luego ser recopilados por una <span className="text-[#c4853a]">IA</span> y enviar las recomendaciones de peliculas para que sean disfrutadas por todos.
            </p>
          </div>
        </section>
      </main>
